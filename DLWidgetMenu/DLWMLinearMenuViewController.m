...
@interface DLWMLinearMenuViewController () <DLWMMenuDataSource, DLWMMenuItemSource, DLWMMenuDelegate, DLWMMenuItemDelegate>
...
- (void)viewDidLoad {
	...
	DLWMLinearLayout *layout = [[DLWMLinearLayout alloc] init];
	layout.angle = 0.0;
	layout.itemSpacing = 45.0;
	layout.centerSpacing = 50.0;
...
#pragma mark - DLWMMenuLayout Protocol

- (void)layoutMenu:(DLWMMenu *)menu {
